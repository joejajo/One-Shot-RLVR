...
# One-Shot-RLVR training — Qwen2.5-Math-1.5B, π₁ r128, 8×A100, single node
# (original 8-GPU script — updated for HPC, no wandb, absolute paths)
#
# NOTE: requires 8 GPUs. For 4-GPU runs use training_1.5b_pi1_r128_4xa100.sh
#
# Run with:
...
TENSORBOARD_LOG_DIR=${REPO_ROOT}/output/tensorboard/verl_few_shot/Qwen2.5-Math-1.5B-pi1_r128_8xa100
MODEL_OUTPUTS_JSONL=${REPO_ROOT}/output/model_outputs/val_generations_pi1_r128_8gpu.jsonl
LOG_FILE=${REPO_ROOT}/output/logs/training_pi1_r128_8xa100.log
