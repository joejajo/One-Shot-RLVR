#!/bin/bash
# =============================================================================
# training_1.5b_pi1_r128_apptainer.sh
...
#   slurm/one_shot_rlvr_apptainer.slurm
#
...
#     bash scripts/train/training_1.5b_pi1_r128_apptainer.sh
#
# Resume (pass total_epochs as first arg):
#   bash training_1.5b_pi1_r128_apptainer.sh 600   # job 2
#   bash training_1.5b_pi1_r128_apptainer.sh 900   # job 3
# =============================================================================
set -euo pipefail
set -x
...
# ---------------------------------------------------------------------------
RUN_NAME="run03_merge_pi1_pi13_1000steps_no_entropy"              # <-- label for this training run
...
TRAIN_FILE=${REPO_ROOT}/data/train/one_shot_rlvr/merge_pi1_pi13_r128.parquet
